...
ifeq ($(config),debug)
  OBJDIR     = obj/Debug/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardd
...
ifeq ($(config),release)
  OBJDIR     = obj/Release/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardr
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardd
  DEFINES   += -DGLEW_STATIC -DDEBUG
  INCLUDES  += -Ilib/glfw/include -Isrc -Icommon -Ilib
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardr
  DEFINES   += -DGLEW_STATIC -DNDEBUG
  INCLUDES  += -Ilib/glfw/include -Isrc -Icommon -Ilib
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardd
  DEFINES   += -DGLEW_STATIC -DDEBUG
  INCLUDES  += -Ilib/glfw/include -Isrc -Icommon -Ilib
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/002_forward
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/002_forwardr
  DEFINES   += -DGLEW_STATIC -DNDEBUG
  INCLUDES  += -Ilib/glfw/include -Isrc -Icommon -Ilib
...
$(OBJDIR)/002_forward.o: 002/002_forward.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
