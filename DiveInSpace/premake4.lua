solution "DiveInSpace - OpenGL project - IMAC3 2014"
   ...
   project "DiveInSpace"
      kind "ConsoleApp"
      language "C++"
      files { "src/main.cpp", "src/Camera.cpp", "src/Shader.cpp", "src/ShaderManager.cpp", "src/LightManager.cpp", "src/TextureManager.cpp"}
